...
import { TabContent2, TabContent3, TabContent5 } from "../components/moderatorContent";
...
const ModeratorPanel = () => {
  ...
  const tabItems = [
    ...
    { id: "#link3", title: kretsar.Krets2 || "Krets2 Ej specificerad", content: <TabContent2 kretsar={kretsar.Krets2} />, },
  ];

  const tabItems3 = [
    { id: "#link6", title: "Aktiviteter" },
    { id: "#link7", title: `Aktivitet1 # ${Activities.Activityid1 !== null ? Activities.Activityid1 : "Ej specificerad"}`, content: <TabContent3 activity={Activities.Activityid1} />, },
    { id: "#link8", title: `Aktivitet2 # ${Activities.Activityid2 !== null ? Activities.Activityid2 : "Ej specificerad"}`, content: <TabContent3 activity={Activities.Activityid2} />, },
    { id: "#link9", title: `Aktivitet3 # ${Activities.Activityid3 !== null ? Activities.Activityid3 : "Ej specificerad"}`, content: <TabContent3 activity={Activities.Activityid3} />, },
  ];
  ...
  const nonClickableLinks = ["#link1", "#link4", "#link6"];
